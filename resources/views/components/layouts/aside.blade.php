<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
  ...
  data-kt-drawer-toggle="#kt_aside_mobile_toggle" :nav="$nav">
  <!--begin::Brand-->
  <div class="aside-logo flex-column-auto" id="kt_aside_logo">
    <!--begin::Logo-->
    <a href="">
      <img alt="Logo" src="{{ asset('media/logos/logo-2.svg') }}" class="h-30px me-3 logo" />
      <span class="fs-3 text-white fw-bold">MyCourse</span>
    </a>
    <!--end::Logo-->
    <!--begin::Aside toggler-->
  ...
  <div class="aside-menu flex-column-fluid">
    ...
    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
      ...
      <div
        ...
        <div class="menu-item">
          <a class="menu-link {{ $nav == 'Dashboard' ? 'active' : '' }}" href="{{ route('dashboard') }}">
        ...
        <div class="menu-item">
          <a class="menu-link {{ $nav == 'Kursus' ? 'active' : '' }}" href="{{ route('course.index') }}">
            <span class="menu-icon">
              <!--begin::Svg Icon | path: icons/duotune/coding/cod003.svg-->
              <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
        ...
        <div class="menu-item">
          <a class="menu-link {{ $nav == 'Materi' ? 'active' : '' }}" href="{{ route('material.index') }}">
            <span class="menu-icon">
              <!--begin::Svg Icon | path: icons/duotune/coding/cod003.svg-->
              <span class="svg-icon svg-icon-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
